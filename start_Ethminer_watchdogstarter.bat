...
ethminer.exe -RH -X --exit -U -P stratum+ssl://0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.rig4@eu1.ethermine.org:5555 -P stratum+ssl://0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.rig4@us1.ethermine.org:5555
...
echo ###############################################################################
echo.
echo   ETHERMiNERWatchDog Version %V%
echo.
echo   AUTHOR: SiMSeK  (DiGiTaLPaRa - TO-GitHub)
echo.
echo ###############################################################################
echo.
echo ETHERMiNERWatchDog
echo 1. Run ethminer.
...
echo ===============================================================================
echo %pISOdate%
echo ETHERMiNERWatchDog_SMSK has run %loopnum% times.
echo ===============================================================================
echo.

rem ========== File Output ==========

echo %pISOdate% ETHERMiNERWatchDog_SMSK has run %loopnum% times.>>%FileOut%
