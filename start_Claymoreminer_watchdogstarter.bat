...
EthDcrMiner64.exe -epool eu1.ethermine.org:4444 -ewal 0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671 -eworker rig4 -epsw x -etht 1ms -eres 0 -ethi 16 -dcrt 5ms -etha 0 -mode 0 -mport 0 -allpools 1
...
chcp 437 >nul
rem Set title
title CLAYMORE WatchDog Version %V% by DiGiTaLPaRa_SiMSEK_2018
...
echo ###############################################################################
echo.
echo   CLAYMOREminerWatchDog Version %V%
echo.
echo   AUTHOR: SiMSeK  (DiGiTaLPaRa - TO-GitHub)
echo.
echo ###############################################################################
echo.
echo CLAYMOREminerWatchDog
echo 1. Run CLAYMORE.
echo 2. Restart CLAYMORE up to 5 times.
echo 3. Reboot the system.
echo.
echo Additional:
echo - AutoFix #385 issue of CLAYMORE
echo - AutoFix #189 issue of CLAYMORE
...
echo CLAYMOREminerWatch Version %V% >> %FileOut%
...
echo ===============================================================================
echo %pISOdate%
echo CLAYMOREminerWatchDogSMSK has run %loopnum% times.
echo ===============================================================================
echo.

rem ========== File Output ==========

echo %pISOdate% CLAYMOREminerWatchDogSMSK has run %loopnum% times.>>%FileOut%
...
echo %pISOdate% CLAYMOREWatchDogSMSK has run %loopnum% times.>>%FileOut%
